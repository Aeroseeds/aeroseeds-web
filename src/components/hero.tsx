    ...
    <>
      <section className="relative w-full h-screen overflow-hidden bg-[#2A1615]">
        ...
        <div className="relative z-20 w-full h-full flex flex-col">
          ...
          {/* Main Hero Text - Centered vertically since Nav is now floating */}
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          ...
          {/* MODAL CONTAINER */}
          <div className="w-full max-w-[500px] bg-[#F7E7A8] rounded-[24px] p-6 md:p-8 shadow-2xl relative max-h-[95vh] overflow-y-auto">
            
            {/* HEADER */}
            <h2 className="font-serif text-4xl md:text-[40px] font-bold text-[#131313] leading-tight tracking-tight mb-3">
              Be part of what's<br/>being built.
            </h2>
            <p className="font-mono text-sm text-[#131313]/80 leading-relaxed mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6">
              {["Farmer", "Investor", "An Organisation", "Following the mission"].map((role) => (
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl border border-[#131313] font-mono text-sm transition-colors ${
                    activeRole === role 
            ...
            <div className="space-y-5">
              ...
              <div>
                <label className="block font-mono text-[13px] text-[#131313] mb-2">
                  What brought you here?
                </label>
                <textarea 
                  rows={3}
                  placeholder="How you found us what resonated.."
                  className="w-full bg-white border border-[#131313] rounded-xl px-4 py-3 font-mono text-sm text-[#131313] placeholder-[#131313]/40 focus:outline-none focus:ring-1 focus:ring-[#131313] resize-none"
                ></textarea>
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-white border border-[#131313] rounded-xl px-4 py-3 font-mono text-sm text-[#131313] placeholder-[#131313]/40 focus:outline-none focus:ring-1 focus:ring-[#131313]"
                />
              </div>
            ...
            <div className="flex items-center gap-3 mt-8">
              <button 
                ...
                className="flex-1 py-3.5 rounded-full border border-[#131313] bg-transparent text-[#131313] font-mono font-semibold text-sm hover:bg-[#131313]/5 transition-colors"
              >
                Cancel
              </button>
              <button 
                onClick={() => setIsModalOpen(false)}
                className="flex-1 py-3.5 rounded-full bg-[#131313] text-[#F7E7A8] font-mono font-semibold text-sm hover:bg-black transition-colors"
              >
                Get Involved
              </button>
            </div>
